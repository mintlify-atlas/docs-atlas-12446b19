  ...
  <Tab title="Renta – Cálculo Anual">
    ...
    **Declaration:** Filed on form **D-101** via ATV by December 15 each year.
    ...
    ```json
    {
      "liquidacion": {
        "tipo": "Renta",
        "periodoFiscal": "2025-10-01/2026-09-30",
        "ingresoBruto": 6000000,
        "deducciones": 1200000,
        "rentaNetaImponible": 4800000,
        "tasaAplicada": 0.15,
        "impuestoBruto": 720000,
        "pagosACuenta": 250000,
        "impuestoAPagar": 470000,
        "formulario": "D-101"
      }
    }
    ```
...
```json
{
  "transaccion": {
    ...
    "tipoCambio": 528.50,
    "montoCRC": 169120,
    "fuenteTipoCambio": "BCCR_REFERENCIA"
  }
}
```
