...
| Concepto | Monto (₡) |
|---|---|
| Ingresos brutos del año fiscal | 12,500,000 |
| Mantenimiento y reparaciones | −800,000 |
| Depreciación del inmueble | −250,000 |
| Seguro de propiedad | −180,000 |
| Comisiones de plataforma | −1,250,000 |
| Honorarios de administración | −600,000 |
| **Total gastos deducibles** | **−3,080,000** |
| **Renta neta imponible** | **9,420,000** |

Aplicando la escala progresiva sobre ₡9,420,000:

| Tramo | Cálculo | Impuesto parcial (₡) |
|---|---|---|
| Hasta ₡4,461,000 (0 %) | ₡4,461,000 × 0 % | 0 |
| ₡4,461,001 – ₡6,624,000 (10 %) | ₡2,163,000 × 10 % | 216,300 |
| ₡6,624,001 – ₡9,420,000 (15 %) | ₡2,796,000 × 15 % | 419,400 |
| **Impuesto total determinado** | | **635,700** |
...
| Opción | Descripción |
|---|---|
| Tipo de entidad | Persona física o jurídica (determina la escala o tasa aplicable) |
| Régimen tributario | Capital Inmobiliario (15 %) o Actividades Lucrativas (escala progresiva) |
| Categorías de gastos deducibles | Tipos de gasto que reducen la base imponible |
| Tasa de depreciación de edificaciones | Porcentaje anual de desgaste (predeterminado: 2 %) |
| Fecha de vencimiento D-101 | Día y mes de la declaración anual (predeterminado: 15 de diciembre) |
