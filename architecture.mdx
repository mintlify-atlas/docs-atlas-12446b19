---
title: "Arquitectura del Sistema FiscalHost Inteligente CR"
sidebarTitle: "Arquitectura"
description: "Arquitectura modular M1–M5 de FiscalHost Inteligente CR: flujo de procesamiento fiscal, responsabilidades por módulo y estrategia Git del equipo."
---
...
Cada push a `main` o `develop`, y cada Pull Request abierto contra estas ramas, dispara automáticamente el pipeline de integración y despliegue continuo configurado mediante GitHub Actions.
